...
public class Locadora {
	...
	// Método processar para o usuario escolher o que deseja fazer
			...
			case "2":
				try {
					int velocidadeMaxima = Integer
							.parseInt(JOptionPane.showInputDialog("Digite a velocidade maxima do carro:"));
	...
	// Método para adicionar um carro ao vetor
	...
	// Método para buscar o carro por modelo e cor para realizar uma venda
	...
	// Opção para que o usuario compre um carro
	...
	// Adiciona a lista em ordem crescente num textarea e nessa area adiciona um
	// scroll
	...
	// Adiciona a lista em ordem decrescente num textarea e nessa area adiciona um
	// scroll
	...
	// Método para buscar um carro no vetor através do modelo
	...
	// Método para buscar um carro no vetor através da velocidade máxima
	...
	// Método para buscar um carro no vetor através do combustível
	...
	// Método que exibe a lista ordenada
	...
	// Método para buscar um carro no vetor através da cor
